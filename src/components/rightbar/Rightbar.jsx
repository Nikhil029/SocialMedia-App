      ...
      <>
        ...
        <div className="rightbarFollowings">
          <div className="rightbarFollowing">
            ...
            />
            <span className="rightbarFollowingName">James Andrew</span>
          </div>
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Lucy Shrum</span>
          </div>
          <div className="rightbarFollowing">
            <img
          ...
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Gary Duke</span>
          </div>
          <div className="rightbarFollowing">
            <img
